...
export const PDF_COLORS = {
  // Couleurs INESIC
  inesicOrange: [255, 102, 0] as [number, number, number],    // Orange INESIC
  inesicGreen: [0, 150, 136] as [number, number, number],     // Vert INESIC
  inesicLightOrange: [255, 152, 0] as [number, number, number],
  inesicLightGreen: [77, 182, 172] as [number, number, number],
...
export const REPORT_TYPE_LABELS: { [key: string]: string } = {
  ...
  sakkanal: 'Rapport de Recommandation Sakkanal'
};